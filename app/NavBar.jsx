            ...
            <div className="py-1 px-2 flex">
             <div className="menu-pr ">
              <div className="pl-3 menu-btn  pr-2 cursor-pointer">
                <div className="flex items-center border border-gray-600 px-1.5 py-1.5 bg-[#00000059] rounded-full pointer relative">
                  <span className="icon dark-icon relative">
                      ...
                      <span className="absolute bg-fuchsia-500 right-1 rounded-full h-2.5 w-2.5 top-0 z-20"></span>
                  </span>
                </div>
              </div>
              ...
              <div className="menu-pr ">
                  ...
                  <div  className="avatar menu-btn flex items-center  border border-[#71247c] bg-[#00000059] hover:!bg-fuchsia-500 px-1.5 py-1.5 rounded-3xl cursor-pointer relative" >
                        ...
                        <div className="flex flex-col  pt-4 rounded-tl-xl bg-[#ffebce]">
                              <div className=" px-4 flex">
                                ...
                                <div className="flex-85 pl-3">
                                    ...
                                    <span className="text-[13px] text-gray-600">Search Colleges, Exams, Courses & More</span>
                                    </div>
                                </div>
                              </div>
                              <div className="px-4 py-3">
                              ...
                              <div className="px-4 pt-2 pb-2">
                                <div className="flex items-center justify-center rounded py-1.5 px-2 bg-orange-500">
                                  <span className="pl-1 text-sm text-white  capitalize">Login / Register</span>
                                </div>
                              </div>
                           </div>    
