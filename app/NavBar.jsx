            ...
            <div className="py-1 px-2 flex">
             <div className="menu-pr ">
              ...
              <div className="menu-pr ">
                  ...
                  <div  className="avatar menu-btn flex items-center  border border-gray-600 bg-[#00000059] hover:!bg-orange-400 px-1.5 py-1.5 rounded-3xl cursor-pointer relative" >
