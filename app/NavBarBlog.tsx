...
const NavBarBlog = ({menusData}:Props) => {
  ...
  return (
    <>
    <nav 
    className={`flex main-nav max-sm:flex-col sm:h-[90px] h-[64px] sm:w-11.4/12 sm:mx-auto dark:max-sm:border-b bg-white dark:max-sm:border-b-gray-700   w-full pt-2 sm:py-2 z-50 items-center justify-between font-bold  `}
    >
        ...
        <div className=" flex-60 flex justify-center">
            ...
            <span className='w-32 sm:w-[2.7rem] mr-1.5 inline-block'>
              <img className='w-full max-w-full light-logo' src={imagePath2} ref={logoRef1}  alt="" />
            </span>
              </Link>
        </div>
        ...
        <div className="p-2 max-sm:hidden text-[#333]">
            <Link href="/" className={` text-2xl sm:text-xl flex items-center pl-1 sm:pl-4   font-bold`} > 
            <div className='sm:w-36 inline-block'>
              <img className='w-full max-w-full light-logo' src={imagePath2} ref={logoRef2}  alt="" />
            </div>
              </Link>
        </div>
        ...
        <div className={`main-drop-menu max-sm:hidden sm:justify-end text-sm max-sm:h-lvh sm:flex-80  max-sm:bg-gray-100 max-sm:overflow-y-auto hidden max-sm:text-gray-600 max-sm:absolute max-sm:left-0 max-sm:top-16 max-sm:w-full font-semibold sm:flex sm:items-center sm:text-base  `} > 
          ...
          <div className='max-sm:h-full  max-sm:bg-white px-4 sm:px-0 max-sm:border max-sm:border-gray-200 sm:flex sm:items-center'>
            ...
            <div className="">
              <div className="pl-3 pr-0.5 cursor-pointer">
                <div className="flex them-switcher  items-center border bg-gray-100 border-gray-200 dark:border-gray-600 px-1.5 py-1.5 dark:bg-[#00000059] rounded-full text-gray-50 pointer relative">
                  <ThemeToggle />
                </div>
              </div>
            </div>
            ...
            <div className="px-2">
              <div className=" pr-0.5 cursor-pointer">
                <div className="flex locl-toggle  items-center border bg-gray-100 border-gray-200 dark:border-gray-600 px-1.5 py-1.5 dark:bg-[#00000059] rounded-full pointer relative">
                  <LocaleSwitcher />
                </div>
              </div>
            </div>
