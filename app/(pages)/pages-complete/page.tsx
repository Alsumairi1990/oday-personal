...
const Portfolio = () => {
   ...
   return (
      <div className="w-full" >
        ...
        <div className="my-12 grid grid-cols-2 gap-4 mx-auto w-10/12 p-6">
            ...
            <div className="flex items-center py-1 text-gray-700 font-semibold">
                <span className="mr-3 capitalize">2- Service ( Single page ) </span>
                <span className="w-5 inline-block">
                    <svg width="100%" height="100%" viewBox="0 0 117 117" version="1.1" xmlns="http://www.w3.org/2000/svg" >
                        <title/><desc/><defs/>
                        <g fill="none" fill-rule="evenodd" id="Page-1" stroke="none" stroke-width="1">
                ...
                <span className="text-gray-600 font-semibold text-md ml-4 border-l border-l-gray-400 pl-4">[ oday-app/service/( serviceName ) ]</span>
            </div>

            <div className="flex items-center py-1 text-gray-700 font-semibold">
                <span className="mr-3 capitalize">3- Services (services page ) </span>
                <span className="w-5 inline-block">
                    <svg width="100%" height="100%" viewBox="0 0 117 117" version="1.1" xmlns="http://www.w3.org/2000/svg" >
                        <title/><desc/><defs/>
                        <g fill="none" fill-rule="evenodd" id="Page-1" stroke="none" stroke-width="1">
