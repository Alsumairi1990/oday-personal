...
import { Phase, Price, Service, Tag, Tool } from '@prisma/client';
...
import { getTools } from '@/app/admin/tools/_actions/Actions';
import {  getServiceById, getServicePhasesById, getServiceWPhasesById } from '../../_serviceActions/ServiceActions';
import { getServicePricesById } from '../_actions/Actions';
...
const PhaseDisplay = ({id}:ShowProps) => {
   ...
   const [prices, setPrices] = useState<PriceWithModels[] | null>(null);
    ...
    <div className="flex-100  bg-white sm:rounded-lg shadow-md ">
            ...
            <div className="relative overflow-x-auto  scr-container overflow-y-autحo">
                <div className="w-full text-sm text-left  rtl:text-right text-gray-500 dark:text-gray-400">
                     {showGrid && prices && prices?.length > 0 && 
                        <GridView prices={prices} unSelected={unSelected} getSelected={getSelected}  />
                        }
