                ...
                .map((element, index) => (
                    ...
                    <div className=" w-full  sm:flex sm:mx-auto items-center bg-white border-r border-r-gray-300 rounded-l-md">
                     ...
                     <div className="flex gap-x-2 flex-20  justify-center  ">
                          ...
                          <Link href={`/admin/service/phases/display/${element.id}`} className="inline-flex items-center justify-center bg-blue-100 border !border-blue-200 hover:!bg-blue-200 py-0.5 rounded-md flex-23">
