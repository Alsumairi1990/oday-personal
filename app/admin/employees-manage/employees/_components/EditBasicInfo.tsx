...
const EditBasicInfo = ({ employee}: FormEditProps) => {
   ...
   <div className="flex items-center relative justify-center w-full ">
           ...
           {employeeData && <form onSubmit={handleSubmit(saveUser)} className=' bg-white border border-gray-300 rounded-md shadow-xl w-full' >
                <div className="flex w-full pb-2 pt-2  pl-2 border-b border-b-gray-200">
                 <span className="text-lg  font-semibold text-gray-600">Basic Info </span> 
               </div>
              ...
              <div className=" sm:flex-100 flex flex-col z-0 w-full mb-5 ">
                  ...
                  <div className="mb-4 flex flex-100 ">
                    ...
                    <button type='submit' 
                    className='py-1.5 px-2.5 shadow-sm font-medium text-md  bg-gray-100 hover:bg-slate-500 hover:text-gray-50 border-gray-200 text-gray-700 rounded-lg '>
                        Cancel
                    </button>
                    <button type='submit' 
                    className='py-1.5 px-2.5 shadow-sm font-medium text-md   bg-indigo-600 hover:bg-violet-700 border-violet-600 hover:border-violet-700 text-white rounded-xl '>
                        Save Changes
                    </button>
                    </div>
