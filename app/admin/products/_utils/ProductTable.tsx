...
const ServiceTable = ({productss,searchParam,getSelected,unSelected}:Props) => {
...
const addSelected= (selected:string)=>{
  ...
  return (
    ...
    <Link href={`/admin/productss/edit/${option.id}`} className="inline-flex items-center justify-center bg-sky-100 border !border-sky-200 hover:!bg-sky-200 rounded-md py-1.5 flex-23">
    ...
    <Link href={`/admin/productss/show/${option.id}`} className="inline-flex items-center justify-center bg-blue-100 border !border-blue-200 hover:!bg-blue-200 rounded-md flex-23">
