...
const CategoryTable = ({categories,getSelected,unSelected}:Props) => {
    ...
    const removeItem = (array:string[], item:string) => {
      ...
      const sendSelected = (id: string) => {
            
        
                  if(selectedValues?.includes(id)){selectedValues = removeItem(selectedValues, id);}
                    else{selectedValues.push(id);}
                    
            
            // getSelected(selectedValues);
            console.log("size od send selected called on check"+selectedValues.length)
        }
              
        // const unSelected = (id: string) => {
        //   console.log("id"+id)
        //             selectedValues = removeItem(selectedValues, id);
        //     console.log("size od send selected called on UNNcheck"+selectedValues.length)
        // }
        
      let [mu,setMu] = useState('');
