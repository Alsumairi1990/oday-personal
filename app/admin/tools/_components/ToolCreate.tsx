...
import { addingTool } from '../_actions/Actions';
import SuccessMessage from '../utils/SuccessMessage';




type inputType = z.infer<typeof toolSchema>;


const ToolCreate = () => {
    const [tool, setTool] = useState<Tool| null>(null); // Use Category type
  ...
  const handleIconChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    const saveUser: SubmitHandler<inputType> = async (data)=>{
      ...
      try {
        const toolData =  await addingTool(formData);
        setTool(toolData);
      } catch (error) {
