...
const GridView = ({tools,getSelected,unSelected}:Props) => {
        ...
        <div className=" relative border flex flex-wrap my-4 w-11.8/12 mx-auto items-center  border-gray-200 rounded-md " >
           ...
           <TagCard   tool={element} />
            ...
            {/* {editShow && <FormEdit name={category.name} closeModel={closeModel}  /> } */}
                <Link href={`/admin/tools/show/${element.id}`} className="inline-flex items-center justify-center bg-blue-100 border !border-blue-200 hover:!bg-blue-200 rounded-md flex-23">
...
{showDelete && <DeleteTag toolIds={selectedValues} closeModel={closeDelet}  /> }
{}
