...
import { getTags } from '../_actions/Actions';
    ...
    <div className="flex-100  bg-white sm:rounded-lg shadow-md ">
                ...
                <div className="px-2 w-full flex pb-3 border-b border-b-gray-300">
                    <div className="flex max-sm:flex-col items-center">
                     ...
                     {svalues.length>0 && <div className='sm:ml-4'>
                      ...
                      {showDelete && <DeleteTag tagIds={svalues} closeModel={closeConfirm}  />}  
            ...
            <div className="relative overflow-x-auto  scr-container overflow-y-autحo">
                <div className="w-full text-sm text-left  rtl:text-right text-gray-500 dark:text-gray-400">
                     {showGrid && tags && tags?.length > 0 && 
                        <GridView tags={tags} unSelected={unSelected} getSelected={getSelected}  />
                        }
                    {showTable && tags && tags?.length > 0 && 
                    <TableView tags={tags} unSelected={unSelected} getSelected={getSelected}  />
                    } 
                    {showGridCols && tags && tags?.length > 0 && 
                    <GridColsView tags={tags} unSelected={unSelected} getSelected={getSelected}  />
                    } 
                </div>
            </div>
