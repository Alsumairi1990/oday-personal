...
import { addProjectCategory, createProjectCategory, getProjectWCategorylById, removeProjectCategory } from '../_actions/Actions';
...
const CategoryCreate = ({projectId}:Props) => {
