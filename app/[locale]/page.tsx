...
import { AboutUsSection, Category, HeroSection, Industry, PageSection, Post, Service, Testimonial } from '@prisma/client'
...
try {
  ...
  return (
    <main className="flex flex-col dark:bg-[#111]">
     ...
     <div className="dark:bg-[#111]">
     {posts &&  <Blogs meta={blogsMeta} posts={posts}  /> }
     </div>
     <div className="">
     </div>
     <div className="dark:bg-black-100">
