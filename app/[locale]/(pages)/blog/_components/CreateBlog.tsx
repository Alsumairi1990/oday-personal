"use client";
import AddingBtn from "@/app/_components/admin/blogs/AddingBtn";
import TextEditor from "@/app/_components/admin/editor/TextEditor";
...
const CreateBlog = () => {
  ...
  return (
    <div className="flex flex-wrap min-h-[100vh] h-auto">
      <div
        id="add-main-panel"
        className="w-11.8/12 mx-auto add-main-panel  flex h-full flex-col  rounded-md  borrder borrder-gray-200 bg-whitey"
      >
        <div className="flex-100 grid grid-cols-2 sm:grid-cols-5 gap-4 rdounded bjg-[#4568e7] px-2.5 ">
          <div className="add-main">
            ...
            />
            {isOpen("basic") && (
              <div className="fixed flex add-form bg-[#00000061]  items-center justify-center top-0 left-0 h-full w-full z-50">
                <div
                  className="flex flex-col w-full sm:w-full h-full add-menu  bg-white items-center rfounded-md  border border-gray-300 "
                  style={{ boxShadow: "rgb(82 63 104 / 12%) 0px 0px 10px 0px" }}
                >
                  <div className="flex w-full rofunded-t-md py-1 items-center px-3 border-b bg-[#dbdbdb29] border-b-gray-200 ">
                    <div className="flex items-center">
                      <span className="inline-flex h-full w-6 pb-1 justify-center items-center">
                        <svg
                          className="w-full h-full icon line-color fill-black icon flat-color"
                          width="50px"
                          height="50px"
                          viewBox="0 0 24 24"
                          id="add-file-6"
                        ...
                        >
                          <path
                            id="secondary"
                            className="fill-none stroke-gray-900 stroke-1"
