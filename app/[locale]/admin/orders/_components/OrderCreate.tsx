...
const close = (v:boolean)=> {
  ...
  return (
    ...
    <div id="add-main-panel" className="w-full relative  mx-auto add-main-panel bg-white mb-6 grid grid-cols-1 sm:grid-cols-3  flex-col  rounded-md  borrder borrder-gray-200 bg-whitey">
        
        <div className="grid grid-cols-1 sm:grid-cols-1 sticky sm:top-10 gap-4 h-fit rounded bg-white  px-2 py-3 "  >
