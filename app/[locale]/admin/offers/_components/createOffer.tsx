...
import { addOffer, getOffers } from '../_actions/Actions';
...
type inputType = z.infer<typeof OfferSchema>;
     ...
     <form onSubmit={handleSubmit(saveUser)} className=" text-start z-40 bg-white rounded-md border border-gray-200 ">
        ...
        <div className=" flex-100  flex  flex-col z-10 w-full mb-5 ">
            ...
            <div className=" flex sm:flex-48 flex-col z-0 w-full mb-5 group">
                    ...
                    <div className="flex items-center w-full">
                        <div className="relative flex w-full">
                        <input {...register('discount')}  type="number" name="discount" id="discount" className="block pl-2 h-10 px-0 z-0 w-full text-sm text-gray-900 border rounded-xl border-gray-300 appearance-none  bg-gray-50 focus:outline-none focus:ring-0 focus:border-orange-500 peer" placeholder="10%,20%,30% ...." required />
                        </div>
                    </div> 
            ...
            <div className=" flex flex-col flex-48 z-0 mt-2 w-full mb-5 group">
                    <label htmlFor="startDate" className="font-medium mb-2 text-sm  text-gray-500 dark:text-gray-400 duration-300 capitalize">start Date </label>
                    <div className="flex items-center w-full">
                        <div className="relative flex w-full">
                        <input 
                          {...register('startDate')}
                         type="date" name="startDate" id="startDate" className="block pl-2 h-10 px-0 z-0 w-full text-sm text-gray-900 bg-gray-50 border rounded-xl border-gray-300  dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-orange-500 peer" placeholder="Start Date  ..." required />
                        </div>
                    </div> 
                    <span className="text-red-400 text-xs mt-2">{errors.startDate?.message} </span>
            </div>
            <div className=" flex flex-col flex-48 z-0 mt-2 w-full mb-5 group">
                    <label htmlFor="endDate" className="font-medium mb-2 text-sm  text-gray-500 dark:text-gray-400 duration-300 capitalize">end Date </label>
                    <div className="flex items-center w-full">
                        <div className="relative flex w-full">
                        <input 
                          {...register('endDate')}
                         type="date" name="endDate" id="endDate" className="block pl-2 h-10 px-0 z-0 w-full text-sm text-gray-900 bg-gray-50 border rounded-xl border-gray-300  dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-orange-500 peer" placeholder="End Date  ..." required />
                        </div>
                    </div> 
