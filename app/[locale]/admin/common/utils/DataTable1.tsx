...
const DataTable1 = () => {
   ...
   const [options, setOptions] = useState([
    {id:'1',name:'Designing',type:'Peinting',website:'www.hgfregfbre.com',established_date : 'ed'},
    {id:'2',name:'Web Developemnt ',type:'typ',website:'Socail ',established_date : 'ed'},
    {id:'3',name:'Card Generate',type:'Pering',website:'mabet ',established_date : 'ed'},
    {id:'4',name:'Screen web',type:'marketing',website:'ergreg',established_date : 'ed'},
    {id:'5',name:'Figma Design',type:'scial marketing',website:'we',established_date : 'ed'},
   ]);
  ...
  return (
    ...
    <tr className="bg-white font-medium text-sm capitalize flex border-b dark:bg-gray-800 dark:border-gray-700">
    ...
    <td className="flex-20 text-center text-gray-600 font-medium py-4">
        {option.name}
    </td>
    <td className="flex-20  text-center py-4">
        {option.type}
    </td>
    <td className="flex-20 text-center py-4">
            {option.website}
    ...
    <td className="flex-20 text-center py-4">
            {option.established_date}
    </td>
    <td className="flex-15 flex  text-center py-4 justify-around">
    <span className="inline-flex items-center justify-center bg-sky-100 border !border-sky-200 hover:!bg-sky-200 rounded-md flex-23">
