...
const GridColsView = ({tags,getSelected,unSelected}:Props) => {
     ...
     tags.map((tag:any) => (
        <div className=" relative border flex flex-col my-4 w-[98%] mx-auto items-center  border-gray-200 rounded-md " >
           ...
           <div className="flex gap-x-2 my-2 justify-center px-3 ">
                <button onClick={()=>{setEditShow(true); setCatName(tag?.name)  }} className="inline-flex items-center justify-center bg-sky-100 border !border-sky-200 hover:!bg-sky-200 px-1.5 rounded-md py-1.5 flex-30">
                ...
                <Link href={`/admin/tag/show/${tag.id}`} className="inline-flex items-center justify-center bg-blue-100 border !border-blue-200 hover:!bg-blue-200 px-1.5 rounded-md flex-30">
