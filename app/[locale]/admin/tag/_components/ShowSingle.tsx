...
import { getTagById } from '../_actions/Actions';
...
const ShowSingle = ({ id}: FormEditProps) => {
  const [tag, setTag] = useState<TagWithUser | null>(null); 
  const [baseUrl, setBaseUrl] = useState<string>('');
  const [showEdit, setShowEdit] = useState<boolean>(false);

  const getCategory = async () => {
    const categoryDa = await getTagById(id);
    setTag(categoryDa);
  };
                ...
                <div className="flex items-center flex-col">
                    <div className="w-10/12 relative lack rounded-md border border-gray-300">
                     <div className="p2 bg-black rounded-md border-[.3rem] border-white">
                        {/* <span>jherhfref</span> */}
                       <img className=' h-full opacity-70  rounded-md' src={`${baseUrl}/${tag?.image}`} alt="" />
                     </div>
                     ...
                     <div className="absolute  px-2 rounded-md justify-center left-0 flex space-x-4  bottom-4   right-2">
                        <div className="p-2 flex-25 capitalize text-md bg-white border border-gray-500  flex flex-col space-x-2 space-y-3 items-center rounded-md">
                          <img className='w-9 h-9  border border-gray-300 justify-center rounded-md '  src={`${baseUrl}/${tag?.icon}`} alt="" />
                          <div className="flex">
                            <span className='text-gray-800 font-semibold mr-1'>Name : </span> 
                            <span className='text-orange-500 font-medium ml-1'>{tag.name}</span> 
                          </div>
                         </div>
                         <div className="p-2 flex-25 capitalize text-md bg-white border border-gray-500  flex flex-col space-x-2 space-y-3 items-center rounded-md">
                          ...
                          <div className="flex">
                            ...
                            <span className='text-orange-500 font-medium ml-1'>{tag.slug}</span> 
                          </div>
                         </div>
                         <div className="p-2 flex-25 capitalize text-md bg-white border border-gray-500  flex flex-col space-x-2 space-y-3 items-center rounded-md">
                          ...
                          <div className="flex">
                            ...
                            <span className='text-orange-500 font-semibold ml-1'>{tag.id}</span> 
                          </div>
                         </div>
                    ...
                    <div className="text-center sm:p-0.5 ">
                      ...
                      <div className="px-2 my-2 py-3 flex border-b border-b-gray-200  ">
                        <div className="flex-25 border-r border-r-gray-300">
                          <span className="text-base font-semibold pl-2">Tag Name </span>
                        </div>
                        <div className="flex-75 pl-4 ">
                          <div className="text-md text-gray-800 font-medium">{tag.name}</div>
                        </div>
                      </div>
                      <div className="px-2 my-2 py-3 flex border-b border-b-gray-200  ">
                        <div className="flex-25 border-r border-r-gray-300">
                        ...
                        <div className="flex-75 pl-4 ">
                          <div className="text-md text-gray-800 capitalize font-medium">{tag?.user?.user_name}</div>
                        </div>
                      </div>
                      <div className="px-2 my-2 py-3 flex border-b border-b-gray-200  ">
                        <div className="flex-25 border-r border-r-gray-300">
                          <span className="text-base font-semibold pl-2">Tag Slug </span>
                        </div>
                        <div className="flex-75 pl-4 ">
                          <div className="text-md text-gray-800 font-medium">{tag.slug}</div>
                        </div>
                      </div>
                      <div className="px-2 my-2 py-3 flex border-b border-b-gray-200  ">
                        <div className="flex-25 border-r border-r-gray-300">
                        ...
                        <div className="flex-75 pl-4 ">
                          <div className="text-md text-gray-800 font-medium leading-8">{tag.description}</div>
                        </div>
                      </div>
                      <div className="px-2 my-2 py-3 flex border-b border-b-gray-200  ">
                        <div className="flex-25 border-r border-r-gray-300">
                        ...
                        <div className="flex-75 pl-4 ">
                          <div className="text-md text-gray-800 font-medium leading-8">{tag.name}</div>
                        </div>
                      </div>
                      <div className="px-2 my-2 py-3 flex border-b border-b-gray-200  ">
                        <div className="flex-25 border-r border-r-gray-300">
