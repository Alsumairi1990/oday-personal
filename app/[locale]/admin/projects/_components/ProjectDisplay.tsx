...
function ProjectDisplay() {
    ...
    const [projects, setProjects] = useState<ProjectAnalyticsModel[]>([])
  ...
  const getServiceAnlytics = async () => {
    ...
    try {
      setLoading(true);
      const catg = await getProjectWithAnalytics();
      if(catg) setProjects(catg);
      setLoading(false);
    } catch (error: any) {
      setLoading(false);
          ...
          <div className="bg-gra-100 flex-40 border border-gray-200 rounded-3xl py-1.5 w-full h-10 ">
            ...
            <div className="flex-60">
                <div 
                    ...
                    <span className="text-md capitalize">Create Project</span>
