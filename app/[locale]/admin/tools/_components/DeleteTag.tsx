...
import { deleteTools } from '../_actions/Actions';
...
const DeleteTag = ({toolIds,closeModel}:Props) => {
  ...
  const deleteRows = async () => {
       const results = await deleteTools(toolIds);
       setResult(results);
      ...
      {toolIds && result.length == 0 &&
            ...
            <div className="flex items-center bg-indigo-500 py-2.5 px-2 rounded-t-md">
             ...
             <div className="p-2 flex justify-center py-4">
                <span className="text-gray-700 text-md font-semibold capitalize">
                    you are going to delete {toolIds.length} rows
                </span>
             </div>
        ...
        {result.length>0 && 
                ...
                <div className="flex items-center bg-green-500 py-2.5 px-2 rounded-t-md">
                 ...
                 <div className="p-2 flex justify-center py-4">
                    <span className="text-gray-700 text-md font-semibold capitalize">
                       {toolIds.length} rows - hase been deleted
                    </span>
                 </div>
