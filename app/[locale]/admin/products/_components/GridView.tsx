...
import ProductCard from '../_utils/ProductCard';
...
const GridView = ({products,getSelected,unSelected}:Props) => {
     ...
     products.map((element:any) => (
        <div className=" relative border flex flex-wrap my-4 w-11.8/12 mx-auto items-center  border-gray-200 rounded-md " >
           ...
           <ProductCard   element={element} />
            ...
            <Link href={`/admin/service/edit/${element.id}`} className="inline-flex items-center justify-center bg-blue-100 border !border-blue-200 hover:!bg-blue-200 rounded-md py-1 flex-23">
