...
import TableLocation from '../utils/TableLocation';
interface Props{
    locations:Location[],
...
const TableView = ({locations,getSelected,unSelected}:Props) => {
      ...
      <table className="w-full text-sm text-left border !border-gray-100 rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody className=''>
                     {locations && locations?.length > 0 && 
                        ...
                        <TableLocation locations={locations} unSelected={unSelected1} getSelected={getSelected2} />
                        }
                    </tbody>
                </table>
