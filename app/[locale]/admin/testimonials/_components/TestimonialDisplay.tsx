...
import { Tag, Testimonial, Tool } from '@prisma/client';
...
import { getTestimonialWModels } from '../_actions/Actions';
...
const ToolDisplay = () => {
   ...
   const [testimonials, setTestimonial] = useState<TestimonialWithModels[] | null>(null);
   ...
   const getAllTestimonials = async () => {
    try {
        setLoading(true)
        const testimonials = await getTestimonialWModels();
    ...
    <div className="flex-100  bg-white sm:rounded-lg shadow-md ">
                ...
                <div className="px-2 w-full flex pb-3 border-b border-b-gray-300">
                    <div className="flex max-sm:flex-col items-center">
                     ...
                     {svalues.length>0 && <div className='sm:ml-4'>
                      ...
                      {showDelete && <DeleteTestimonial ids={svalues} closeModel={closeConfirm}  />}  
            ...
            <div className="relative overflow-x-auto  scr-container overflow-y-autحo">
                <div className="w-full text-sm text-left  rtl:text-right text-gray-500 dark:text-gray-400">
                     {showGrid && testimonials && testimonials?.length > 0 && 
                        <GridView elements={testimonials} unSelected={unSelected} getSelected={getSelected}  />
                        }
