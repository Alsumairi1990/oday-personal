...
import { WorkWithModels } from './WorkWithModels';

interface Props {
    element: WorkWithModels;
  }


const WorkCard = ({element}:Props) => {
           ...
           <div className=" w-full sm:h-32 flex flex-wrap sm:mx-auto items-center bg-white border-r border-r-gray-300 rounded-l-md">
             ...
             <div className="p-2 pl-4 flex-100 sm:flex-77 w-full">
                <div className="w-full mb-2 flex items-center">
                    <img className=' rounded-md w-6  mr-2' src={`${baseUrl}/${element?.icon}`} alt="" />
                    ...
                    <div className="ml-auto">
                      ...
                      <span className="text-sm text-red-700 ml-1 capitalize">{ element?.user?.user_name}</span>
                    </div>
                </div>
                <div className="">
                    ...
                    <span className="text-sm text-gray-900 font-medium">{element?.location?.country}</span>
                </div>
