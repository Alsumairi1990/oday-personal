           ...
           <div className=" w-full flex flex-col sm:mx-auto items-center bg-white rounded-t-md">
             ...
             <div className="p-2 pl-4 flex-100 mt-1">
                <div className="w-full mb-2 flex items-center">
                    ...
                    <span className="text-base  text-black  font-semibold">{element?.country}</span>
                ...
                <div className="mt-2.5">
                    <span className="text-sm font-normal line-clamp-2 leading-6">{element?.city}</span>
                </div>
             </div>
           </div>
        }
