...
const GridColsView = ({codes,getSelected,unSelected}:Props) => {
    ...
    <div className='grid sm:grid-cols-3 gap-4'>
    {
     codes.map((element:any) => (
        <div className=" relative border flex flex-col my-4 w-[98%] mx-auto items-center  border-gray-200 rounded-md " >
           ...
           <div className="">
           <CardCol   code={element} />
           </div>
           <div className="flex gap-x-2 my-2 justify-center px-3 ">
                <button onClick={()=>{setEditShow(true); setToolName(element?.code)  }} className="inline-flex items-center justify-center bg-sky-100 border !border-sky-200 hover:!bg-sky-200 px-1.5 rounded-md py-1.5 flex-30">
