...
const TagCreate = ({serviceId}:Props) => {
...
const getSelected= (selected:string)=>{
  ...
  const removeTool  = async () => {
    ...
    const createTool = async () => {
      try {
        if(serviceId != 0 && tagName != ''){
          setLoading(true);
          const tgname = await createServiceTag(serviceId , tagName);
          setLoading(false);
          setError(null)
          setTagNames((prevToolNames) => [...prevToolNames, tgname]);
        }
        setShowAdd(false);
      } catch (error:any) {
         setError(error); 
          ...
          <div className="w-5/12 bg-white animate-modalEnter rounded-md shadow-lg p-4">
                 <div className="flex w-full border border-gray-300 bg-gray-200 rounded-md py-2.5 items-center px-3 border-b border-b-gray-300" style={{boxShadow:'0 6px 19px -13px #9f9494;'}}>
                      <div className="flex items-center">
                          ...
                          <span className="text-base font-semibold text-gray-600">Remove Service Tag</span>
                      </div>
                  ...
                  <div className=" flex flex-col z-0 w-full mt-2 mb-5 group pt-2">
                      <span className='text-red-500'>You are going to remove Service Tag</span>
                  </div>
                 ...
                 <div className="flex w-full border border-gray-300 bg-gray-200 rounded-md py-2.5 items-center px-3 border-b border-b-gray-300" style={{boxShadow:'0 6px 19px -13px #9f9494;'}}>
                  ...
                  <div className=" flex flex-col z-0 w-full mt-2 mb-5 group pt-2">
                      ...
                      <div className="flex items-center w-full">
                        ...
                        <input  
                        onChange={(e) => addTaglName(e.target.value)}
