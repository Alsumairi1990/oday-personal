...
import { addServiceCategories, addServiceTags, addServiceTools, addServiceWorks, getServices, getWorks, removeServiceCategory, removeServiceTag, removeServiceTool, removeServiceWork } from "../_serviceActions/ServiceActions";
...
const WorksPanel = ({ service, colseModel }: FormEditProps) => {
            ...
            <div className="p-2 w-full bg-slate-50 border border-gray-200">
              ...
              <div>
                <div className="py-2 pt-1 flex items-center border-b border-b-gray-300 flex-wrap overflow-y-auto">
                  {serviceData.works.length > 0 && <h3 className="text-gray-500 pb-1 text-md w-full border-b">list of added works</h3>
                  }
                  <div className="flex items-center rounded-md w-full gap-2 max-h-40 flex-wrap overflow-y-auto">
                   {serviceData.works && serviceData.works.length>0 ?  (
                   
                          <div className="py-2 grid grid-cols-7 gap-2 items-center ">
                          {serviceData.works.map(element => (
                            <div className="rounded-md p-1 bg-white border border-gray-200">
                                ...
                                <button
                                  onClick={() => {
                                    if(serviceData.tools.length>0) setRemovedTool(element.title);
                    ...
                    >
                      ...
                      {selectedMenuElements.length>0 ? (
                        ...
                        <div className="text-md inline-flex text-gray-600 font-medium capitalize">
                          <span className="px-1">Adding Works</span>
                        </div>
                      )}
