  ...
  return (
    <div className="shadow-lg  bg-white dark:bg-black-150 border dark:border-gray-600 rounded-xl w-11/12 mx-auto  " style={{boxShadow:' 3px 3px 40px rgb(0 0 0/15%)'}}>
     <div className="grid grid-cols-3 ">
        <div className="pr-8">
            <div className="bg-[#162d42] dark:bg-black-100 dark:border-r rounded-l-xl dark:border-r-gray-800 h-full">
                <div className="flex mb-4 justify-between pt-5 pb-1 px-4">
                    <div className=" flex flex-col flex-100  border rounded border-[rgba(0,0,0,0.125)] p-2 text-center col-6 flex-fill">
                        <div className="p-1 pb-0">
                            ...
                            <p className="text-lead-feature flex-50 text-md text-white dark:text-gray-900 font-weight-semibold mb-0">If not Forms, brief us @mail@konstantinfo.com</p>
                            <p className="text-lead-feature flex-50 text-sm text-white dark:text-gray-900 font-weight-semibold mb-0">+90547114547</p>
                        </div>
                    </div>
                </div>


                <div className="flex mb-4 justify-between pb-1 px-4">
                    <div className=" flex flex-col flex-100 border rounded border-[rgba(0,0,0,0.125)] p-2 text-center col-6 flex-fill">
                        <div className="p-1 pb-0">
                            <span className="icon inline-block flex-50 w-[4.5rem] icon-lead ">
                            ...
                            <p className="text-lead-feature flex-50 text-md text-white dark:text-gray-900 font-weight-semibold mb-0">If not Forms, brief us @mail@konstantinfo.com</p>
                            <p className="text-lead-feature flex-50 text-sm text-white dark:text-gray-900 font-weight-semibold mb-0">+90547114547</p>                        </div>
