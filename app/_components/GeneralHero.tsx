...
const GeneralHeroSection = ({ heroData, locale,messages,page }: ServiceProps) => {
    const talkToConsultant = (messages as any).CategoryPage.talkToConsultant;
    const home = (messages as any).Common.home;
  return (
        <div className="w-full " >  
        <div className=" sm:h-[calc(100%-350px)] hero-section pt-[100px] sm:pb-8 flex px-4 relative w-full bg-no-repeat bg-center bg-cover -z-0" style={{backgroundImage: `url(${heroData.image})`}}>
