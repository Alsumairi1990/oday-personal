                    ...
                    <div className="">
                          <div className="rounded-md h-full flex gap-y-4 flex-col">
                              ...
                              {otherPosts2.map((post, index) => (
                                  <div className="flex flex-wrap relative flex-grow">
                                      <div className="flex-100 ">
                                           <img className="w-full max-w-full h-full rounded" src={post.image || "/images/w01.png"}  alt="" />
                                      </div>
                                      <div className="flex-100 absolute bottom-0 w-full">
                                        <div className="">
                                            {post && post.categories.length > 0 &&
                                            <p className="text-md mb-1 font-arabic">
                                                {post.categories[0].nameAr}
                                            </p>
                                            }
                                        </div>
