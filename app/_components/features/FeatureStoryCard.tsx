...
import { Feature, Post } from '@prisma/client';
interface Props {
    post: Post;
    locale : string,
  ...
  return (
    ...
    <div  className=" relative flex flex-col p-1  rounded-md bg-gray-100 dark:bg-[#111] ">
        ...
        {locale == 'en' ? <div className=" h-full w-full flex flex-col pt-1 items-center justify-center ">
            ...
            <p className="text-gray-800 text-sm tracking-8  leading-7 px-1.5 dark:text-gray-100 line-clamp-5 font-medium mb-4">{post.content}</p>
        ...
        <div className="font-arabic w-full flex flex-col h-full pt-1 items-center justify-center ">
            ...
            <p className="text-gray-800 text-sm   leading-7 px-2 dark:text-gray-100 line-clamp-5 font-medium mb-4">{post.contentAr}</p>
        </div>
          }
       </div>
    </div>
