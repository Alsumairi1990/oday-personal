...
function WhatsAppLive() {
  ...
  return (
    <div>
          <a href={whatsappURL}  target="_blank" rel="noopener noreferrer" className="focus:outline-none w-14 inline-flex">
          <svg className='w-full h-full' version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"  
                ...
                <g>
                    ...
                    <path fill="#fff" d="M47.683,37.985c-1.316-2.487-6.169-5.331-6.169-5.331c-1.098-0.626-2.423-0.696-3.049,0.42
