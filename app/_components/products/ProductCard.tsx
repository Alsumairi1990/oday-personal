...
const ProductCard = ({ product,locale,messages } : Props) => {
  ...
  return (
    ...
    <div className=" py-2 text-center rounded-md shadow-xl border border-gray-200">
     <div className="flex px-2 h-56 sm:h-[17rem] overflow-hidden justify-center">
        ...
        <div className="mt-4 font-arabic px-2">
            <p className="text-gray-800 text-md font-bold dark:text-orange-500 mb-2">{product.nameAr}</p>
