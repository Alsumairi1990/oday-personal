            ...
            <div className="flex flex-col p-2  my-3 pb-3 border-b border-gray-300">
                <div className="px-2 w-full flex pb-3 border-b border-b-gray-300">
                    <div className="flex items-center">
                        <h5 className="font-semibold text-lg text-capitalize mb-0 text-gray-800 ">Found 103 colleges</h5>
                       <button v-if="deleteSelectValues.length>0" className="py-1 ml-2 px-2 bg-rose-700 text-white rounded-md text-sm capitalize" onClick={showDeleteConfirm}>Delete Selected</button>
                    </div>
                ...
                <div className="flex-100 space-x-3 items-center mt-3 flex px-2">
                    <div className="text-md text-gray-400 py-1 flex items-center capitalize border-r px-2 border-gray-300">
                   ...
                   <div className="px-2 relative filter-panel rounded py-1.5 border !border-gray-300">
                   ...
                   <div className="px-2 relative filter-panel rounded py-1.5 border !border-gray-200">
                        <button onClick={(event) => openMenu(event)} className="inline-flex capitalize option-btn group relative w-full  items-center   text-sm  text-gray-600 rounded-xl focus:!border-orange-500 focus:outline-none peer-focus:!text-orange-500 focus:ring-orange-500" type="button">
