...
const ServiceTable = () => {
  ...
  return (
    ...
    <tr className="bg-white font-medium capitalize flex border-b dark:bg-gray-800 dark:border-gray-700">
    ...
    <td className="flex-20 text-center text-gray-600 font-semibold py-4">
        {option.name}
    </td>
