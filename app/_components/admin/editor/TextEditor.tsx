...
const [isFontMenuVisible, setIsFontMenuVisible] = useState(false);
  ...
  return (
    <div  className="">
       <div className="p " style={{backgroundImage: 'linear-gradient(360deg, #f7f7f7, #ffffff, #f9f9f9);     box-shadow: 0 2px 5px -2px #9d9898'}}>
            ...
            <div className="flex px-4 border-b bg-[#dbdbdb14] border-b-gray-200 bg-gradioent-to-t from-[#e1e4e5] to-[#fbfbfb]">
                  <div className="relative edit-btn flex flex-col items-center">
                    <button onClick={toggleFileMenu} className="text-sm font-semibold pl-3 pr-1 py-1 text-gray-600 rounded">
                      File
                    </button>
                    {isFileMenuVisible && (
                      <div className="absolute edit-menu top-[35px] left-0 flex flex-col bg-white overflow-y-auto max-h-40 z-[40] border-x border-y border-x-gray-300 border-y-gray-300">
                        <p className="mb-0 p2 bg-gray-300 text-sm px-2">
                          Paragrapg
                        </p>
                        <div className="p-2 flex flex-col">
                          <button onClick={() => console.log("File H1 clicked")} className="text-sm py-1 w-[25px] font-semibold text-gray-600">
                            H1
                          </button>
                          <button onClick={() => console.log("File H2 clicked")} className="text-sm py-1 w-[25px] font-semibold text-gray-600">
                            H2
                          </button>
                        </div>
                      </div>
                  ...
                  <div className="relative edit-btn flex flex-col items-center">
                    <button onClick={toggleViewMenu} className="text-sm font-semibold pl-3 pr-1 py-1 text-gray-600 rounded">
                      View
                    </button>
                    {isViewMenuVisible && (
                      <div className="absolute edit-menu top-[35px] left-0 flex flex-col bg-white overflow-y-auto max-h-40 z-[40] border-x border-y border-x-gray-300 border-y-gray-300">
                        ...
                        <div className="p-2 flex flex-col">
                          <button onClick={() => console.log("View H1 clicked")} className="text-sm py-1 w-[25px] font-semibold text-gray-600">
                            H1
                          </button>
                          <button onClick={() => console.log("View H2 clicked")} className="text-sm py-1 w-[25px] font-semibold text-gray-600">
                            H2
                          </button>
                        </div>
                      </div>
                  ...
                  <div className="relative edit-btn flex flex-col items-center">
                    <button onClick={toggleEditorMenu} className="text-sm font-semibold pl-3 pr-1 py-1 text-gray-600 rounded">
                      Editor
                    </button>
                    {isEditorMenuVisible && (
                      <div className="absolute edit-menu top-[35px] left-0 flex flex-col bg-white overflow-y-auto max-h-40 z-[40] border-x border-y border-x-gray-300 border-y-gray-300">
                        ...
                        <div className="p-2 flex flex-col">
                          <button onClick={() => console.log("Editor H1 clicked")} className="text-sm py-1 w-[25px] font-semibold text-gray-600">
                            H1
                          </button>
                          <button onClick={() => console.log("Editor H2 clicked")} className="text-sm py-1 w-[25px] font-semibold text-gray-600">
                            H2
                          </button>
                        </div>
                      </div>
                  ...
                  <button type="button" onClick={toggleFileMenu} className="text-sm ml-auto font-semibold pl-3 pr-2 py-1 text-gray-600 rounded">
                    <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M12 22C17.5 22 22 17.5 22 12C22 6.5 17.5 2 12 2C6.5 2 2 6.5 2 12C2 17.5 6.5 22 12 22Z" stroke="#555" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                      <path d="M9.16998 14.83L14.83 9.17004" stroke="#555" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                      <path d="M14.83 14.83L9.16998 9.17004" stroke="#555" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </button>
                 ...
                 <div className="flex gap-y-2 px-4 flex-wrap relative" style={{boxShadow: '0 2px 5px -2px #9d9898'}}>
                    ...
                    <div className="p-2 flex flex-20 gap-y-3 flex-wrap items-center border-r border-r-gray-200">
                            <button
                              ...
                              <div className="relative edit-btn flex flex-col items-center w-[85px] mx-2" onClick={toggleEditMenu}>
                             ...
                             <button
                              ...
                              <div className="relative edit-btn flex flex-col items-center pt-1 w-[55px] mx-1">
                                      ...
                                      >
                                        <span className="leading-[21px] font-semibold mr-0.5">Font</span>
                                      ...
                                      {isFontMenuVisible && (
                                        <div className="absolute edit-menu top-[35px] left-0 flex flex-col bg-white z-[40] border-x border-y border-x-gray-300 border-y-gray-300">
                                          ...
                                          <div className="p-2 flex w-48 flex-wrap gap-y-1 justify-between">
                                            ...
                                            ></button>
                                            <button
                                              onClick={() => editor.chain().focus().toggleHighlight({ color: '#000' }).run()}
                                              className="flex-15 bg-black text-sm w-[25px] font-semibold text-gray-600"
                                            ></button>
                                            <button
                                              onClick={() => editor.chain().focus().toggleHighlight({ color: '#4b5563' }).run()}
                                      ...
                                      <div className="relative flex edit-btn flex-col items-center w-[35px] mr-1">
                                            <button onClick={toggleMenu} className="text-md text-gray-600 w-[35px] px-1 pb-0.5 rounded">
                                                <span className="font-bold px-0.5 border-b-2 border-b-gray-500 mr-0.5">A</span>
                                            ...
                                            <div className={`absolute edit-menu ${showMenu ? 'block' : 'hidden'} top-[35px] left-0 flex flex-col bg-white z-[40] border-x border-y border-x-gray-300 border-y-gray-300`}>
                                                ...
                                                <div className="p-2 flex w-48 flex-wrap gap-y-1 justify-between">
                                                 <button
                                                    ...
                                                    className={`flex-15 bg-[#958DF1] text-sm w-[25px] font-semibold text-gray-600 ${editor.isActive('textStyle', { color: '#958DF1' }) ? 'is-active' : ''}`}
                                                    data-testid="setPurple"
                                                  >   
                                                  </button>     
                                               {/*   <button
                                                        onClick={() => editor.chain().focus().setColor('#F98181').run()}
                                                        className={`flex-15 bg-[#F98181] text-sm w-[25px] font-semibold text-gray-600 ${editor.isActive('textStyle', { color: '#958DF1' }) ? 'is-active' : ''}`}
                                                        data-testid="setRed"
                                                      >  
                                                  </button>  */}                                          
                                                </div>
