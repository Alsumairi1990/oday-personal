      ...
      <div className="flex flex-col sm:py-8  dark:bg-[#080808]">
        ...
        <div className="grid grid-cols sm:grid-cols-4 gap-8 mt-8">
         ...
         {services.map((service) => (
               ...
               <div className="dark:pb-2 pb-3 pt-2 dark:pt-0 dark:sm:pb-5 w-24 bg-gray-300 dark:bg-[#080808]  sm:w-[7rem] dark:sm:w-[rem] rounded-xl  px-4 dark:px-0 flex items-center mx-auto ">
               ...
               <div className="sm:p2 mt-4 text-center">
                 ...
                 <div className="p-1 flex flex-col sm:flex-row justify-around mt-6 mb-4">
                   <button className='px-4 py-1.5 border dark:border-[0.13rem] max-sm:mb-4 border-gray-300 dark:border-[#4a235e] rounded text-gray-700 dark:text-gray-100 text-sm' style={{borderRadius:'36px 67px'}} >Request 
                  
                   </button>
                   <button className='px-4 py-1.5  flex items-center justify-center border-[0.13rem] bg-orange-500 border-orange-500 dark:bg-[#00ba35] dark:border-[#00ba35] rounded text-white dark:text-black font-semibold text-sm' style={{borderRadius:'36px 67px'}} >details 
                   <span className="ml-2">
          ...
          <div className="p-2 flex flex-col justify-center pt-4 sm:pt-8 border shadow-lg dark:shadow-0 dark:max-sm:bg-[#171717] rounded-xl border-gray-200 dark:border-gray-600 dark:sm:border-[#8849a9]">
            ...
            <div className="sm:p2 mt-4 text-center">
              ...
              <div className="p-1 flex flex-col sm:flex-row justify-around mt-6 mb-4">
                ...
                <Link href={'/services/category/fd'} className='px-4 py-2  flex items-center justify-center border-[0.13rem] bg-orange-500 border-orange-500 dark:bg-[#00ba35] dark:border-[#00ba35] rounded text-white dark:text-black font-semibold text-sm' style={{borderRadius:'36px 67px'}} >Service Info 
                <span className="ml-2">
                <svg height="15px" width="15px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" 
                        viewBox="0 0 512 512" >
                      <path fill="#FFFFFF" d="M256,504C119.248,504,8,392.752,8,256S119.248,8,256,8s248,111.248,248,248S392.752,504,256,504z"/>
