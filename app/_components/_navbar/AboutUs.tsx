       ...
       <div className="">
          <ul className="grid sm:grid-cols-3 gap-y-4 pb-2">
             <li className=" line-height-20 pr-6">
                <a href="/about-us" className="flex items-center w-full border border-gray-200 pl-2 rounded-lg py-2.5">
                   <span className="">
             ...
             <li className=" line-height-20 pr-6">
                <a href="/reviews" className="flex items-center w-full border border-gray-200 pl-2 rounded-lg py-2.5">
                   <span className="">
                      <svg width="21" height="21" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
             ...
             <li className=" line-height-20 pr-6">
                <a href="/sam-team" className="flex items-center w-full border border-gray-200 pl-2 rounded-lg py-2.5">
                   <span className="">
                      <svg width="21" height="21" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
             ...
             <li className=" line-height-20 pr-6">
                <a href="/portfolio" className="flex items-center w-full border border-gray-200 pl-2 rounded-lg py-2.5">
                   <span className="">
                      <svg width="21" height="21" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
             ...
             <li className=" line-height-20 pr-6">
                <a href="/contact-us" className="flex items-center w-full border border-gray-200 pl-2 rounded-lg py-2.5">
                   <span className="">
                      <svg width="21" height="21" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
             ...
             <li className=" line-height-20 pr-6">
                <a href="/testimonials" className="flex items-center w-full border border-gray-200 pl-2 rounded-lg py-2.5">
                   <span className="">
                      <svg width="21" height="21" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
             ...
             <li className=" line-height-20 pr-6">
                <a href="/our-process" className="flex items-center w-full border border-gray-200 pl-2 rounded-lg py-2.5">
                   <span className="">
