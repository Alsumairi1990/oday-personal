    ...
    <div className="bg-gray-100 border border-gray-300 rounded-xl shadow-xl dark:bg-[#151515] pb-5">
        <div className="bg-black-150 rounded-2xl flex flex-col justify-center items-center">
            <div className=" py-4 bg-[#151318] w-full rounded-t-xl border border-gray-500" >
                {locale === 'en' ? <div>
                  <p className="text-white text-xl text-center  font-semibold px-4">{plan.name}<span className="text-[#ff7900] mt-2 text-md block">: 30,000 </span><span className="text-[#ff7900] block text-sm">Sam Company LDT </span></p>
                ...
                <p className="text-white text-2xl text-center  font-semibold px-4">{plan.nameAr}<span className="text-[#ff7900] mt-2 text-2xl block">{plan.yearlyPrice.toString()}$</span></p>
