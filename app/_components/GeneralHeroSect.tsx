...
const GeneralHeroSect = ({ title,titleAr,subTitle,subTitleAr, locale,messages,page,pageAr, image }: ServiceProps) => {
          ...
          <div className="flex w-11/12 mx-auto relative">
             <div className="flex-100 sm:flex-60">
               ...
               <>
                ...
                :
                <>
                <span className="text-sm text-white font-arabic mb-6 inline-block">{home} / {pageAr} </span>
                <h2 className="sm:text-3xl text-xl text-white font-extrabold font-arabic mb-2 line-clamp-3 sm:mb-4">{titleAr}</h2>
                <h2 className="text-md sm:text-lg sm:leading-8 text-white font-bold line-clamp-2 sm:line-clamp-3 font-arabic mb-4">{subTitleAr}</h2>
                </>
                }
                ...
                <div className="flex mt-2 sm:mt-6 max-sm:mb-3 items-center  ">
                   <div className="px-2 flex items-center py-1 sm:py-2 rounded-md bg-[#f85508] ">
                      <span className="w-4  ltr:mr-1 rtl:ml-1 bainline-block">
                      ...
                      <span className=" inline-block text-white text-sm  font-semibold rtl:font-arabic ">{talkToConsultant}</span>
                   </div>
