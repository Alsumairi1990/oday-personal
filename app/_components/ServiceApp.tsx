    ...
    <div className="shfadow-lg  bg-white dark:bg-[#161616] border dark:border-gray-600 rounded-md w-11.6/12 sm:w-11/12 mx-auto  " >
     <div className="grid sm:grid-cols-3 ">
                ...
                <div className="flex mb-4 justify-between py-6 px-4">
                    <div className=" flex flex-col flex-48 bg-white dark:bg-[#111] dark:border dark:border-gray-700 border rounded border-[rgba(0,0,0,0.125)] p-2 text-center col-6 flex-fill">
                        <div className="p-1 pb-0">
                            ...
                            <p className="text-lead-feature flex-50 text-[13px] dark:text-gray-50 rtl:font-arabic font-weight-semi mb-0 rtl:font-bold rtl:text-gray-700 ">{t('contact-section1')}</p>
                        </div>
                    ...
                    <div className=" flex flex-col flex-48 bg-white dark:bg-[#111] dark:border dark:border-gray-700 border rounded border-[rgba(0,0,0,0.125)]  p-2 text-center col-6 flex-fill">
                        <div className="p-1 pb-0">
                            ...
                            <p className="text-lead-feature flex-50 text-[13px] dark:text-gray-50  mb-0  rtl:font-arabic rtl:font-bold rtl:text-gray-700">{t('contact-section2')}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex mb-4 justify-between pb-6 px-4">
                    <div className=" flex flex-col flex-48 bg-white dark:bg-[#111] dark:border dark:border-gray-700 border rounded border-[rgba(0,0,0,0.125)] p-2 text-center col-6 flex-fill">
                        <div className="p-1 pb-0">
                            ...
                            <p className="text-lead-feature flex-50 text-[13px] dark:text-gray-50  font-weight-semi mb-0 rtl:font-arabic rtl:font-bold rtl:text-gray-700">{t('contact-section3')}</p>
                        </div>
                    ...
                    <div className=" flex flex-col flex-48 bg-white dark:bg-[#111] dark:border dark:border-gray-700 border rounded border-[rgba(0,0,0,0.125)]  p-2 text-center col-6 flex-fill">
                        <div className="p-1 pb-0">
                            ...
                            <p className="text-lead-feature flex-50 text-[13px] dark:text-gray-50  font-weight-semi mb-0 rtl:font-arabic rtl:font-bold rtl:text-gray-700">{t('contact-section4')}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex  justify-between pb-4 px-4">
                    <div className=" flex flex-col flex-48 bg-white border dark:bg-[#111] dark:border dark:border-gray-700 rounded border-[rgba(0,0,0,0.125)] p-2 text-center col-6 flex-fill">
                        <div className="p-1 pb-0">
                            ...
                            <p className="text-lead-feature flex-50 text-[13px] dark:text-gray-50  font-weight-semi mb-0 rtl:font-arabic rtl:font-bold rtl:text-gray-700">{t('contact-section5')}</p>
                        </div>
                    ...
                    <div className=" flex flex-col flex-48 bg-white border dark:bg-[#111] dark:border dark:border-gray-700 rounded border-[rgba(0,0,0,0.125)]  p-2 text-center col-6 flex-fill">
                        <div className="p-1 pb-0">
                            ...
                            <p className="text-lead-feature flex-50 text-[13px] dark:text-gray-50  font-weight-semi mb-0 rtl:font-arabic rtl:font-bold rtl:text-gray-700">{t('contact-section6')}</p>
                        </div>
                    </div>
                </div>    
            </div>
        </div>
        <div className="sm:col-span-2 pr-4 rtl:pl-5 pt-5">
            <div className="flex flex-col items-center mb-2 justify-center">
                ...
                <h1 className="text-black-150 dark:text-white text-center text-2xl font-semibold rtl:font-arabic">{t('title-sec1')} <span className="text-orange-400">{t('innerTitle')}</span> {t('title-sec2')}</h1>
            </div>
            <div className=" border-b border-b-gray-200 dark:border-gray-800 pb-5">
                <div className="grid grid-cols-2 sm:grid-cols-3 max-sm:px-2">
                    <div className="p-1 ">
                    <input id="LoginEmail" type="email" className="form-input w-full text-[15px] py-2 px-3 h-10 bg-transparent dark:bg-black-100 dark:text-slate-200 rounded-xl outline-none border border-gray-200 focus:border-orange-500 dark:border-gray-800 dark:focus:border-violet-600 focus:ring-0 mt-3 rtl:font-arabic" placeholder={t('name')} />                      
                    </div>
                    <div className="p-1 ">
                    <input id="LoginEmail" type="email" className="form-input w-full text-[15px] py-2 px-3 h-10 bg-transparent dark:bg-black-100 dark:text-slate-200 rounded-xl outline-none border border-gray-200 focus:border-orange-500 dark:border-gray-800 dark:focus:border-violet-600 focus:ring-0 mt-3 rtl:font-arabic" placeholder={t('email')}/>                      
                    </div>
                    <div className="p-1 self-stretch col-span-2 sm:col-span-1">
                    <input id="LoginEmail" type="email" className="form-input w-full text-[15px] py-2 px-3 h-10 bg-transparent dark:bg-black-100 dark:text-slate-200 rounded-xl outline-none border border-gray-200 focus:border-orange-500 dark:border-gray-800 dark:focus:border-violet-600 focus:ring-0 mt-3 rtl:font-arabic" placeholder={t('phonNo')} />                      
                    </div>
            ...
            <div className="p-2 pt-4 ">
                <div className="">
                    <h2 className="text-black-150 dark:text-white textmd font-semibold mb-1.5 rtl:font-arabic rtl:text-sm text-blue-500">{t('sectionTitle')}</h2>
        ...
        <div className="max-sm:px-3">
            ...
            <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-600 dark:text-white rtl:font-arabic rtl:font-bold rtl:text-sm">{t('MessageTitle')}</label>
            <textarea id="message" rows={5}  className="block p-2.5 w-full text-sm text-gray-100 bg-gray-50 dark:bg-[#181818] rounded-lg border border-gray-300 focus:ring-violet-600 focus:border-violet-700 dark:bg-black-150 dark:border-gray-800 dark:placeholder-gray-400 dark:text-white dark:focus:ring-violet-600 dark:focus:border-violet-700 rtl:font-arabic" placeholder={t('messagePlacholder')}></textarea>

        </div>
     </div>
     <div className="my-2 p-2 text-center">
     <a href="" className="bg-orange-500 dark:bg-violet-600 rounded-md px-6 py-1.5 text-white inline-block rtl:font-arabic rtl:font-bold rtl:text-sm">{t('submit')}</a>
     </div>
