        ...
        <div className="grid grid-cols-1">
          ...
          <div className=" flex flex-col z-0 w-full mb-5 group">
                    ...
                    <div className="flex items-center w-full">
                        ...
                        <div className="relative flex items-center border border-gray-300 ltr:rounded-r-md rtl:rounded-l-md h-10   w-full">
                        <input {...register('password')} type={isVisible? "text" : "password"} name="password" id="password" className="block ltr:pl-2 rtl:pr-2 px-0 pt-1 z-0 w-full text-sm text-gray-900 bg-transparent  rounded-md rounded-l-none focus-within:!border-orange-500  appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 peer" placeholder="*********" required />
                         {isVisible ? <FaEye className='mr-2' onClick={toggleVisible} /> : <FaRegEyeSlash className='ltr:mr-2 rtl:ml-2' onClick={toggleVisible} /> }
                        </div>
                    </div> 
                    <span className="text-red-400 text-xs mt-2">{errors?.password?.message} </span> 
            </div>
