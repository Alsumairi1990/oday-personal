...
interface ServiceProps {
    servicefeature: ServiceFeatureInt;
  }
  ...
  return (
    ...
    <div className=" py-3 text-center rounded-md shadow-xl border h-full border-gray-200">
     <div className="flex px-2  justify-center">
        <img src={servicefeature.image} alt="" />
     </div>
        <div className="mt-1.5 ">
            <p className="text-gray-800 dark:text-orange-500 text-xl mb-1 font-semibold ">{servicefeature.name}</p>
            <p className="text-gray-500 text-sm dark:text-gray-200 tracking-8  leading-6 px-1.5 font-medium mb-4">{servicefeature.desc}</p>
