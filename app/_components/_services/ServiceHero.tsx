...
interface ServiceProps {
    service: ServiceForFront;
  }
const ServiceHero = ({ service }: ServiceProps) => {
  return (
     
   <div className="w-full " >  
        <div className=" max-sm:min-h-lvh hero-section pt-[100px] sm:pb-8 flex px-4 relative w-full bg-no-repeat bg-center bg-cover -z-0" style={{backgroundImage: `url(${service.image})`}}>
             ...
             <div className="flex-60">
                ...
                <div className="flex  mt-6 items-center  ">
                   <div className="pl-2 pr-4 flex items-center py-2 rounded-md bg-[#f85508] ">
                      ...
                      <span className=" inline-block text-white text-base font-semibold rtl:font-arabic ">contact us</span>
                   </div>
