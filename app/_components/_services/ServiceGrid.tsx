...
const ServiceGrid = ({service,locale,messages}:Props) => {
         ...
         <div className=" w-full flex flex-wrap border border-gray-300 sm:mx-auto items-center bg-white dark:bg-[#111] rounded-t-md">
           ...
           <div className="p-2 ltr:pl-4 rtl:pr-5 sm:flex-70 mt-1 sm:border-x sm:border-x-gray-300">
              ...
              <div className="">
                  ...
                  {locale === 'en' ?<span className="text-sm text-gray-900 dark:text-gray-50 font-medium"></span>
                  : <span className="text-[13px] text-gray-900 font-arabic dark:text-gray-50 font-medium"></span>
                 }
              </div>
