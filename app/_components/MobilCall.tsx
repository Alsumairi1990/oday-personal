...
function MobilCall({locale,messages,closePanle}:Props) {
  ...
  return (
    ...
    <div className="fixed inset-0 z-[999999] bg-black bg-opacity-50 flex items-center justify-center">
      ...
      <div className="p-2 w-5/12 bg-whited rounded-md " style={{background: 'radial-gradient(circle, rgb(30 113 175) 0%, rgb(4 78 195) 100%)'}}>
       <div className="flex py-1 justify-between border-b border-b-gray-500 mb-2">
        ...
        <div className="p-2">
            <div className="flex gap-x-2 justify-between">
                <div className="p-1 flex-30 flex items-center border border-gray-300 rounded-md bg-white">
                ...
                <div className="p-1 flex flex-30 items-center  border border-gray-300 rounded-md bg-white">
                    <span className="inline-flex w-9">
